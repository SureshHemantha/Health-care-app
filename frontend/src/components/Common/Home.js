        ...
        return (
            ...
            <div style={{marginTop:'300px', marginLeft:'410px'}}>
                <table className="table1">
                    <tr>
                        <th><img src="/images/channeling.png" width="110" height="110" className="d-inline-block align-top img-thumbnail" alt=""/></th>
                        <th><img src="/images/patientinfo.png" width="110" height="110" className="d-inline-block align-top img-thumbnail" alt=""/></th>           
                        <th><a href="#"><img src="/images/payment.png" width="110" height="110" className="d-inline-block align-top img-thumbnail" alt=""/></a></th>
                        <th><a href="/shome"><img src="/images/surgery.png" width="110" height="110" className="d-inline-block align-top img-thumbnail" alt=""/></a></th>
                    ...
                    <tr>
                        ...
                        <td className="td6"><h4 className="hcolor">Surgery</h4></td>
