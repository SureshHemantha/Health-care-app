...
export default class EditSurgery extends Component {
...
: "";
    ...
    componentDidMount(){
        ...
        axios.get(`/post/${id}`).then((res) => {
            if(res.data.success){
                this.setState({
                    surgeryName:res.data.post.surgeryName,
    ...
    render() {
        ...
        return (
            <><h4><a href="/" style={{ textDecoration: 'none' }}>All Surgery Details</a></h4><div className="col-md-8 mt-4 mx-auto">
                <h1 className="h3 mb-3 font-weight-normal">Edit Surgery Details</h1>
